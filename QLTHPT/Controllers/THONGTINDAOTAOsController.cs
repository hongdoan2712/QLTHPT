...
namespace QLTHPT.Controllers
{
    public class THONGTINDAOTAOsController : Controller
    {
        ...
        {
            var tHONGTINDAOTAOs = db.THONGTINDAOTAOs.Include(t => t.CHUYENNGANH).Include(t => t.HINHTHUC).Include(t => t.VANBANG);
        ...
        public ActionResult Create([Bind(Include = "TTDT_MA,HINHTHUCs_HT_MA,CHUYENNGANH_CN_MA,VANBANG_VB_MA")] THONGTINDAOTAO tHONGTINDAOTAO)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TTDT_MA,HINHTHUCs_HT_MA,CHUYENNGANH_CN_MA,VANBANG_VB_MA")] THONGTINDAOTAO tHONGTINDAOTAO)
        {
            if (ModelState.IsValid)
            {
