...
namespace QLTHPT.Controllers
{
    public class CHITIETDANHGIAsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CTDG_MA,CTDG_NGAYDG,HOCSINH_HS_MA,SODANHGIA_SDG_MA")] CHITIETDANHGIA cHITIETDANHGIA)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CTDG_MA,CTDG_NGAYDG,HOCSINH_HS_MA,SODANHGIA_SDG_MA")] CHITIETDANHGIA cHITIETDANHGIA)
        {
            if (ModelState.IsValid)
            {
