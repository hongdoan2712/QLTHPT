...
namespace QLTHPT.Controllers
{
    public class THOIKHOABIEUxController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TKB_MA,LOP_LOP_MA,MONHOC_MH_MA,THU_THU_MA,TIETHOC_TH_MA,CANBO_CB_MA,NAMHOC_NH_MA,HOCKY_HK_MA")] THOIKHOABIEU tHOIKHOABIEU)
        {
