...
namespace QLTHPT.Controllers
{
    public class CHITIET_CHUCVUController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CT_CV_ID,CT_CV_TEN,CANBO_CB_MA,CHUCVU_CV_MA")] CHITIET_CHUCVU cHITIET_CHUCVU)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CT_CV_ID,CT_CV_TEN,CANBO_CB_MA,CHUCVU_CV_MA")] CHITIET_CHUCVU cHITIET_CHUCVU)
        {
            if (ModelState.IsValid)
            {
