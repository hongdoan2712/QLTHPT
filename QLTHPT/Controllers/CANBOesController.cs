...
namespace QLTHPT.Controllers
{
    public class CANBOesController : Controller
    {
        ...
        {
            var cANBOes = db.CANBOes.Include(c => c.CHITIET_CHUCVU).Include(c => c.COQUAN).Include(c => c.KHENTHUONGCB).Include(c => c.KYLUATCB).Include(c => c.THONGTINDAOTAO).Include(c => c.THONGTINLUONG);
