...
namespace QLTHPT.Controllers
{
    public class HOCSINHsController : Controller
    {
        ...
        {
            var hOCSINHs = db.HOCSINHs.Include(h => h.CHITIETDANHGIA).Include(h => h.DANTOC).Include(h => h.KHENTHUONG).Include(h => h.KHOI).Include(h => h.KYLUAT).Include(h => h.LOP).Include(h => h.QUANHUYEN).Include(h => h.TINHTHANH).Include(h => h.XAPHUONG);
        ...
        public ActionResult Create([Bind(Include = "HS_MA,HS_HOTEN,HS_GIOITINH,HS_NGAYSINH,HS_TONGIAO,TINHTHANH_TT_MA,XAPHUONG_XP_MA,KYLUAT_KL_MA,KHENTHUONG_KT_MA,CHITIETDANHGIA_CTDG_MA,QUANHUYEN_QH_MA,DANTOC_DT_MA,LOP_LOP_MA,KHOI_KHOI_MA")] HOCSINH hOCSINH)
        {
            ...
            ViewBag.CHITIETDANHGIA_CTDG_MA = new SelectList(db.CHITIETDANHGIAs, "CTDG_MA", "SODANHGIA_SDG_MA", hOCSINH.CHITIETDANHGIA_CTDG_MA);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HS_MA,HS_HOTEN,HS_GIOITINH,HS_NGAYSINH,HS_TONGIAO,TINHTHANH_TT_MA,XAPHUONG_XP_MA,KYLUAT_KL_MA,KHENTHUONG_KT_MA,CHITIETDANHGIA_CTDG_MA,QUANHUYEN_QH_MA,DANTOC_DT_MA,LOP_LOP_MA,KHOI_KHOI_MA")] HOCSINH hOCSINH)
        {
            if (ModelState.IsValid)
            {
