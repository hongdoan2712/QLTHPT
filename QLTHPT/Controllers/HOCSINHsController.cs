...
namespace QLTHPT.Controllers
{
    public class HOCSINHsController : Controller
    {
        ...
        {
            var hOCSINHs = db.HOCSINHs.Include(h => h.DANTOC).Include(h => h.LOP).Include(h => h.QUANHUYEN).Include(h => h.TINHTHANH).Include(h => h.XAPHUONG);
        ...
        public ActionResult Create([Bind(Include = "HS_MA,HS_HOTEN,HS_GIOITINH,HS_NGAYSINH,HS_TONGIAO,TINHTHANH_TT_MA,XAPHUONG_XP_MA,QUANHUYEN_QH_MA,LOP_LOP_MA,DANTOC_DT_MA")] HOCSINH hOCSINH)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HS_MA,HS_HOTEN,HS_GIOITINH,HS_NGAYSINH,HS_TONGIAO,TINHTHANH_TT_MA,XAPHUONG_XP_MA,QUANHUYEN_QH_MA,LOP_LOP_MA,DANTOC_DT_MA")] HOCSINH hOCSINH)
        {
            if (ModelState.IsValid)
            {
