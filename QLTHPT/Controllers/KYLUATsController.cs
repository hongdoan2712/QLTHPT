...
namespace QLTHPT.Controllers
{
    public class KYLUATsController : Controller
    {
        ...
        {
            var kYLUATs = db.KYLUATs.Include(k => k.HOCSINH);
        ...
        public ActionResult Create([Bind(Include = "KL_MA,KL_HINHTHUC,KL_NGAYKYLUAT,HOCSINH_HS_MA")] KYLUAT kYLUAT)
        {
            ...
            ViewBag.HOCSINH_HS_MA = new SelectList(db.HOCSINHs, "HS_MA", "HS_HOTEN", kYLUAT.HOCSINH_HS_MA);
            return View(kYLUAT);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KL_MA,KL_HINHTHUC,KL_NGAYKYLUAT,HOCSINH_HS_MA")] KYLUAT kYLUAT)
        {
            if (ModelState.IsValid)
            {
