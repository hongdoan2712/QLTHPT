...
namespace QLTHPT.Controllers
{
    public class KYLUATCBsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KLCB_MA,KLCB_NGAY,KLCB_HINHTHUC,CANBO_CB_MA")] KYLUATCB kYLUATCB)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KLCB_MA,KLCB_NGAY,KLCB_HINHTHUC,CANBO_CB_MA")] KYLUATCB kYLUATCB)
        {
            if (ModelState.IsValid)
            {
