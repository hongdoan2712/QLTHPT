...
namespace QLTHPT.Controllers
{
    public class KHENTHUONGCBsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KTCB_MA,KTCB_NGAY,KTCB_THANHTICH,CANBO_CB_MA")] KHENTHUONGCB kHENTHUONGCB)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KTCB_MA,KTCB_NGAY,KTCB_THANHTICH,CANBO_CB_MA")] KHENTHUONGCB kHENTHUONGCB)
        {
            if (ModelState.IsValid)
            {
